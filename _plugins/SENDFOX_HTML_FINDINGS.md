...
- Lists are rendered as native `ul/li` or `ol/li` blocks (inside a table cell wrapper for vertical rhythm), so SendFox editor recognizes them as real list structures.
