---
layout: post
title: "The Price of Experience Cannot Be Hallucinated"
date: 2026-05-13
description: "AI slop does not just pollute technical writing. It counterfeits production experience and makes maintainers clean up fake authority."
...
AI slop is not just filling the web with the predictable cadence Jorge Manrubia rightfully [called out](https://x.com/jorgemanru/status/2053183727514091820). It is fabricating authority. It is letting people skip the work, skip the scar tissue, and still write in the voice of someone who has been there.
...
In the tech world, attach one of these words to a claim and it immediately becomes true. "This does not scale" can kill a project before anyone measures it. "This is not production ready" can sabotage it without a single deploy. I have seen that happen to me. I have seen people admit to doing it to intentionally sabotage projects.
...
The original RubyLLM article opened by saying the author had spent three weeks on the wrong side of the problem before getting something stable in production. That is a powerful claim. It tells the reader to relax and inherit the author's scars.

There were no scars. The author had not even run the first example.

This is why fake experience is worse than fake code. Bad code fails fast. Fake experience lingers. It gets quoted. It gets summarized. It gets used in meetings by people who do not know enough yet to see the hollow center.
...
Not battle scars. Guesses. Bullshit.

I called the second version what it was: phony. The author then hid all comments while keeping the article up.

The publication later removed it after I contacted the editor. The article itself remains under the author's control.
