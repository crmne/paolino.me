...
seo_title: "RubyLLM 1.3: Attachments, Multi-Tenancy & Model Tracking"
date: 2025-06-03
...
We partnered with [Parsera](https://parsera.org) to build a [continuously updated API](https://api.parsera.org/v1/llm-specs) that scrapes model information from provider docs. `RubyLLM.models.refresh!` now pulls from that API. Context windows, pricing, capabilities, and modalities are always current.
