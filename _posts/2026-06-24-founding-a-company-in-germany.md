---
layout: post
title: "Founding a Company in Germany: €11,800 and 7 Months to Get a VAT ID"
seo_title: "Founding a Company in Germany: €11,800 and 7 Months"
date: 2026-06-24
description: "A timeline of founding a company in Germany: €11,800 spent, two companies registered, 203 days to a VAT ID, and a registration nobody mentioned."
tags: [Germany, Startups, Bureaucracy, Plenty]
sendfox_campaign_id: 2916820
last_modified_at: 2026-09-24
---
> **Update, September 24, 2026:** The VAT ID arrived: 203 days after I started, 11 weeks after I asked for it. The tax firm's real bill came too, and the total is now €11,800. The invoices finally went out. Then I found out about a registration nobody had mentioned. [Read the update](#update-september-24-2026).
...
I can send invoices now. It took 229 days from the first call with the law firm to the first invoice with a VAT ID on it.

The VAT ID came by post, as promised. The clients abroad got their invoices, and they paid. In between, Germany had one more surprise for me.

<div class="ftl-tl" markdown="0"><ol><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Jul</span><span class="ftl-cal-d">29</span></span><div class="ftl-ev"><span class="ftl-date">29 Jul</span><p>I stop waiting and bill my German client for coaching sessions going back to April. My first invoices. Paid the same day.</p></div><div class="ftl-money"></div></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Aug</span><span class="ftl-cal-d">14</span></span><div class="ftl-ev"><span class="ftl-date">14 Aug</span><p>The VAT ID is valid from today. The letter is dated tomorrow and takes another week and a half to reach me.</p></div><div class="ftl-money"></div></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Aug</span><span class="ftl-cal-d">19</span></span><div class="ftl-ev"><span class="ftl-date">19 Aug</span><p>The tax numbers arrive. The tax firm asks me to send them my <code>Gewerbeanmeldung</code> for both companies. It is the first time anyone has said the word.</p></div><div class="ftl-money"></div></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Aug</span><span class="ftl-cal-d">25</span></span><div class="ftl-ev"><span class="ftl-date">25 Aug</span><p>The tax firm's bills arrive, one per company. They quoted <code>€630.00</code> for the tax registration.</p></div><div class="ftl-money"><code>€2,748.90</code><span class="ftl-tag">Tax firm, actual</span></div></li><li class="ftl-gap"><span>1 week</span></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Sep</span><span class="ftl-cal-d">2</span></span><div class="ftl-ev"><span class="ftl-date">2 Sep</span><p>Can the tax firm file it for me? No. I have to do it myself, and it should have been done “at the same time as you begin your business activities.”</p></div><div class="ftl-money"></div></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Sep</span><span class="ftl-cal-d">3</span></span><div class="ftl-ev"><span class="ftl-date">3 Sep</span><p>I file it online in one evening, backdated to 24 March, the day of the notary.</p></div><div class="ftl-money"><code>€15.00</code><span class="ftl-tag">Gewerbeanmeldung</span></div></li><li class="ftl-gap"><span>6 days</span></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Sep</span><span class="ftl-cal-d">9</span></span><div class="ftl-ev"><span class="ftl-date">9 Sep</span><p>First invoices to clients abroad, VAT ID printed on them.</p></div><div class="ftl-money"></div></li><li class="ftl-row"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Sep</span><span class="ftl-cal-d">15</span></span><div class="ftl-ev"><span class="ftl-date">15 Sep</span><p>The Finanzamt's deadline for the registration papers passes. The tax firm asks for an extension. The same day, the first payment from abroad lands.</p></div><div class="ftl-money"></div></li><li class="ftl-row ftl-today"><span class="ftl-cal" aria-hidden="true"><span class="ftl-cal-m">Sep</span><span class="ftl-cal-d">24<small>today</small></span></span><div class="ftl-ev"><span class="ftl-date">24 Sep, today</span><p>Three weeks after filing, still no confirmation from the trade office.</p></div><div class="ftl-money"></div></li></ol><div class="ftl-total"><div class="ftl-total-row"><span>Billed by everyone else, as of June</span><code>€7,654.71</code></div><div class="ftl-total-row"><span>Tax firm: the actual bill, not the €630 quote</span><code>+€2,118.90</code></div><div class="ftl-total-row"><span>Trade registration</span><code>+€15.00</code></div><div class="ftl-total-row"><span>Billed by everyone else, now</span><code>€9,788.61</code></div><div class="ftl-total-row"><span>Share capital I cannot touch</span><code>€2,000.00</code></div><div class="ftl-total-row ftl-grand"><span>Total gone</span><code>€11,788.61</code></div><div class="ftl-total-row ftl-zero"><span>Days to a VAT ID</span><code>203</code></div></div></div>

A Gewerbeanmeldung is the registration of your business with the local trade office. In Berlin that's the Bezirksamt. The law says you file it the moment you start doing business. Not after. Skip it and you have committed an administrative offence, with a fine of up to 1,000 euros.

Seven months. A law firm, a notary, a register court, a tax firm with power of attorney over both companies. Nobody mentioned it until August 19th, when the tax firm asked me to send them the confirmation. Confirmation of what?

So, by the letter of the law, every invoice I sent this summer came from a business Berlin didn't know existed. The same Berlin whose court entered that business into its commercial register in April. The court knew. The tax office knew. The trade office, apparently, has to be told separately, by me, for 15 euros.

It is the cheapest and simplest step in the whole saga: one online form, one evening. I filed it on September 3rd. Three weeks later, the confirmation still hasn't arrived. The tax office wants it and has already set a deadline, which passed. My tax firm has asked for an extension.

Meanwhile, the clients' money is already in the account. Some of it went straight back out to the tax firm: quoted €630, billed €2,748.90.
